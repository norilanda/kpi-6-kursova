...
public class MinimaxBenchmark_16
{
    ...
    [Benchmark]
    [ManualBenchmark]
    public void Parallel_Foreach_FirstLevel_4_12_16()
    {
    ...
    [Benchmark]
    [ManualBenchmark]
    public void Parallel_Foreach_FirstLevel_6_9_16()
    {
    ...
    [Benchmark]
    [ManualBenchmark]
    public void Parallel_Foreach_ChooseLevel_2_22_16()
    {
    ...
    [Benchmark]
    [ManualBenchmark]
    public void Parallel_Foreach_ChooseLevel_4_12_16()
    {
    ...
    [Benchmark]
    [ManualBenchmark]
    public void Parallel_Foreach_ChooseLevel_6_9_16()
    {
    ...
    [Benchmark]
    [ManualBenchmark]
    public void Parallel_Foreach_ChooseLevel_250_3_16()
    {
    ...
    [Benchmark]
    [ManualBenchmark]
    public void Parallel_Foreach_ChooseLevel_3000_2_16()
    {
