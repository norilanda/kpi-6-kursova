...
public class MinimaxBenchmark_4
{
    private readonly IMinimax<int> _parallelForeachFirstLevel= new ParallelMinimax_ForEach_FirstLevel(new ParallelOptions() {MaxDegreeOfParallelism = 4});
    private readonly IMinimax<int> _parallelForeachChooseLevel= new ParallelMinimax_ForEach_ChooseLevel(new ParallelOptions() {MaxDegreeOfParallelism = 4});
    ...
    [Benchmark]
    [ManualBenchmark]
    public void Parallel_Foreach_FirstLevel_2_22_4()
    {
    ...
    [Benchmark]
    [ManualBenchmark]
    public void Parallel_Foreach_FirstLevel_4_12_4()
    {
    ...
    [Benchmark]
    [ManualBenchmark]
    public void Parallel_Foreach_FirstLevel_6_9_4()
    {
    ...
    [Benchmark]
    [ManualBenchmark]
    public void Parallel_Foreach_FirstLevel_250_3_4()
    {
    ...
    [Benchmark]
    [ManualBenchmark]
    public void Parallel_Foreach_FirstLevel_3000_2_4()
    {
    ...
    [Benchmark]
    [ManualBenchmark]
    public void Parallel_Foreach_ChooseLevel_2_22_4()
    {
    ...
    [Benchmark]
    [ManualBenchmark]
    public void Parallel_Foreach_ChooseLevel_4_12_4()
    {
    ...
    [Benchmark]
    [ManualBenchmark]
    public void Parallel_Foreach_ChooseLevel_6_9_4()
    {
    ...
    [Benchmark]
    [ManualBenchmark]
    public void Parallel_Foreach_ChooseLevel_250_3_4()
    {
    ...
    [Benchmark]
    [ManualBenchmark]
    public void Parallel_Foreach_ChooseLevel_3000_2_4()
    {
