...
public class ParallelFirstLevelDepthBenchmark
{
    ...
    [ManualBenchmark]
    public void Parallel_Foreach_FirstLevel_5_3()
    {
    ...
    [Benchmark]
    [ManualBenchmark]
    public void Parallel_Foreach_FirstLevel_5_5()
    {
    ...
    [Benchmark]
    [ManualBenchmark]
    public void Parallel_Foreach_FirstLevel_5_8()
    {
    ...
    [Benchmark]
    [ManualBenchmark]
    public void Parallel_Foreach_FirstLevel_5_10()
    {
        _parallel.MinimaxAlgo(_tree_5_10);
    }

    [ManualBenchmark]
    public void Parallel_Foreach_FirstLevel_5_11()
    {
